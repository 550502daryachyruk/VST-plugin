...
def main():
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/MyNewPlugin-RTAS-Info.plist"
...
#   plistpath = scriptpath + "/resources/MyNewPlugin-IOSAPP-Info.plist"
